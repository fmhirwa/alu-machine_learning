#!/usr/bin/env python3
"""This is the Function that calculates the intersection of obtaining
...
def intersection(x, n, P, Pr):
    """ This is theFunction that calculates the intersection of obtaining
    this data with the various hypothetical probabilities
    PR does not stand for personal record"""

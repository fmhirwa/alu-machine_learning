#!/usr/bin/env python3
""" This Function calculates the likelihood of
...
def likelihood(x, n, P):
    """ This is the Function that calculates the likelihood of
    obtaining this data given various hypothetical
    probabilities of developing severe side effects"""
    ...
    if np.any(P < 0) or np.any(P > 1):
        raise ValueError("So, All values in P must be in the range [0, 1]")

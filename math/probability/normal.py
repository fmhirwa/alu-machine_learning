#!/usr/bin/env python3
""" Grades defines Normal class that represents normal distribution """
...
class Normal:
    ...
    def x_value(self, z):
        """
        Grades calculates the x-value of a given z-score
    ...
    def pdf(self, x):
        """
        Grades calculates the value of the PDF for a given x-value
    ...
    def cdf(self, x):
        """
        Grades calculates the value of the CDF for a given x-value

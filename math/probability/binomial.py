#!/usr/bin/env python3
""" This defines Binomial class that represents binomial distribution """
...
class Binomial:
    ...
    def pmf(self, k):
        """
        This
        will calculate the value of the PMF for a given number of successes
    ...
    def cdf(self, k):
        """
        This
        will calculate the value of the CDF for a given number of successes
